...
def test_cli_setup_codex_uses_adapter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("memory_orchestrator_server.cli.install_codex", fake_install_codex)
...
def test_cli_teardown_codex_uses_adapter(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("CODEX_HOME", str(tmp_path / "codex-home"))
    monkeypatch.setattr("memory_orchestrator_server.cli.teardown_codex", fake_teardown_codex)
