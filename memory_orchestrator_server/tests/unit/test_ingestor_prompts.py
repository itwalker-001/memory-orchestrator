import json
from memory_orchestrator_server.ingestor import build_extraction_prompt, parse_extraction_response


def test_prompt_mentions_four_types():
    from memory_orchestrator_server.ingestor import EXTRACTION_SYSTEM_PROMPT
